...
\\\text{Where, } X = i \text{ refers the ith unit being included.}
\end{align}

The first unit in the sample is included if
\begin{align}
    U_1 < \frac{n-n_1}{N-1+1} \brak{ = \frac{n}{N}}
...
\begin{align}
    ...
    \\\therefore \pr{X\neq1,X=2} = \brak{1-\frac{n}{N}}\times\frac{n}{N-1} = \frac{n \brak{N-n}}{N \brak{N-1}}
\end{align}
Hence, option 3 is correct.

From \brak{0.0.14} and \brak{0.0.18}
\begin{align}
